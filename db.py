...
def inicializar_db():
    ...
    tablas = {
        ...
        "plans":        "id INTEGER PRIMARY KEY, code TEXT, category TEXT, name TEXT, gigas INTEGER, price REAL, state INTEGER",
        "promos":       "id INTEGER PRIMARY KEY, code TEXT, category TEXT, name TEXT, description TEXT, state INTEGER",
